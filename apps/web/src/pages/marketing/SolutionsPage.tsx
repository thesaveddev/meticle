...
import {
  ...
  People, Shield,
  Medication, FamilyRestroom, Insights, AssignmentTurnedIn, Map,
  AccessTime,
...
const slModules = [
  ...
  { icon: Insights, title: 'AI intelligence', desc: 'Care summaries, change detection across records, risk signals with source traceability, compliance copilot and manager briefings. AI assists; a person remains responsible for every decision.' },
]
        ...
        <Container maxWidth="lg">
          <Grid container spacing={{ xs: 6, md: 10 }} alignItems="center">
            <Grid item xs={12} md={5}>
              <SectionLabel>Regulatory coverage</SectionLabel>
                ...
                {[
                  ...
                  <Grid item xs={12} sm={6} key={r.code}>
                    <Box component="a" href={r.path} sx={{
                      ...
                      p: 2.5, borderRadius: M.r.lg, border: `1px solid ${M.faint}`,                       bgcolor: M.card, transition: 'all 0.25s',
