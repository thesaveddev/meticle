...
const caseStudies = [
  ...
  },
  {
    ...
    body: 'Maple Leaf Housing received a "Requires Improvement" rating from CQC with compliance flagged as a key concern. They deployed CareDesk across all three homes, used the Training Matrix to close gaps in mandatory training, and leveraged the evidence pack feature to prepare for re-inspection. Six months later they achieved a "Good" rating across all five key questions.'
  },
  {
    ...
    <MarketingLayout>
      <Box sx={{ py: 15, bgcolor: '#F8FAFC', borderBottom: '1px solid #E5E7EB', textAlign: 'center' }}>
        <Container maxWidth="md">
          ...
          <Typography sx={{ color: '#6B7280', fontSize: '1.15rem' }}>
            See how care organisations across the UK are transforming their workforce operations with CareDesk.
          </Typography>
        </Container>
      </Box>
      ...
      <Box sx={{ py: 15, bgcolor: '#0F4C81', color: 'white', textAlign: 'center' }}>
        <Container maxWidth="md">
          ...
          <Typography sx={{ mb: 6, fontSize: '1.25rem', opacity: 0.9 }}>See what CareDesk can do for your organisation.</Typography>
