  ...
  return (
    <Box sx={{ p: 2.5, bgcolor: M.tealSoft, borderRadius: 2, border: '1px solid ' + M.tealMuted }}>
      ...
      <Box sx={{ p: 1.5, bgcolor: 'white', borderRadius: 1.5, border: '1px solid ' + M.tealMuted, mb: 1 }}>
        ...
        <Typography sx={{ fontSize: '0.6rem', color: M.slate, lineHeight: 1.5 }}>Margaret's care needs have increased. Consider reviewing her support plan.</Typography>
      </Box>
      <Box sx={{ p: 1.5, bgcolor: 'white', borderRadius: 1.5, border: '1px solid ' + M.tealMuted }}>
        ...
        <Stack direction="row" alignItems="center" spacing={0.5}>
          ...
          <Typography sx={{ fontSize: '0.6rem', color: M.slate }}>3 missed calls — pattern detected</Typography>
        </Stack>
      </Box>
    </Box>
  )
        ...
        <Container maxWidth="lg">
          <Grid container spacing={{ xs: 6, md: 10 }} alignItems="center">
            <Grid item xs={12} md={6}>
              <SectionLabel>Platform capability</SectionLabel>
        ...
        <Container maxWidth="lg">
          <Grid container spacing={{ xs: 6, md: 10 }} alignItems="center">
            <Grid item xs={12} md={5}>
              <SectionLabel>What your team can do</SectionLabel>
            ...
            <Grid item xs={12} md={7}>
              <Stack spacing={2}>
                {d.capabilities.map((cap) => (
                  <Box key={cap} sx={{ p: 2.5, borderRadius: M.r.md, border: `1px solid ${M.faint}`,  }}>
