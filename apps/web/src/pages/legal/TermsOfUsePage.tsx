  ...
  return (
    ...
    <Container maxWidth="md" sx={{ py: 8 }}>
      ...
      <Section title="5. Data Processing">
        <p>You are the data controller for all personal data you upload to Meticle Care. We act as a data processor. This relationship is governed by our Data Processing Terms (set out in Section 5 below and in our Privacy Policy), which are incorporated by reference into these Terms. You are responsible for:</p>
      ...
      <Section title="8. Limitation of Liability">
        <p>Meticle Care is a compliance support tool, not a substitute for professional legal or regulatory advice. We are not liable for CQC inspection outcomes, regulatory fines, or penalties. Our total liability is limited to the fees paid by you in the 12 months preceding the claim. We are not liable for indirect, consequential, or special damages.</p>
      </Section>

      <Section title="9. Intellectual Property">
        <p>Meticle Care and all associated code, design, and documentation are protected by copyright and intellectual property laws. You retain ownership of all data you upload. We retain ownership of the Service, its code, and its algorithms.</p>
      </Section>
