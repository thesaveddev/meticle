...
export default function AppointmentsPage() {
  ...
  const updateStatus = async (a: any, status: string) => {
    try { await api.patch(`/appointments/${a.id}`, { status }); setViewing((v: any) => v ? { ...v, status } : v); fetchAppointments() }
