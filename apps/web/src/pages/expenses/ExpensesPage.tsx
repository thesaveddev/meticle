...
function LedgerTable({ expenses, onEdit, onVoid, canManage }: any) {
  const empty = <EmptyRow message="No expenses match these filters. Try clearing a filter, or add the first expense for this period." />
  return <>
