...
async function seed() {
  ...
  const locations = [
    ...
    { id: locIds[2], name: 'Meadow View', address: '78 Meadow Road, Bromley BR1 3CD', minStaff: 2, minDay: 2, minNight: 0, serviceType: 'supported_living', capacity: 20, phone: '020 8290 3030', email: 'meadowview@orbisgroup.care', foodRating: null, cqcRating: 'good', lastCqc: '2026-05-12' },
  ]
