...
const MIGRATION_058: Migration = {
  ...
  strict: false,
  statements: [
    `ALTER TABLE cash_balance_checks ADD COLUMN IF NOT EXISTS escalated BOOLEAN DEFAULT FALSE`,
    `ALTER TABLE cash_balance_checks ADD COLUMN IF NOT EXISTS escalation_reason TEXT`,
  ],
};
