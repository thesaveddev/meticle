...
<style>
  ...
  <div class="cover" style="padding:40px;text-align:center;page-break-after:always">
    <div class="badge">Meticle Care</div>
    ...
    <p style="color:#D1D5DB;font-size:11px;margin-top:40px">Generated by Meticle Care on ${now}</p>
  </div>
  ...
  <div style="margin-top:40px;padding-top:12px;border-top:1px solid #D1D5DB;font-size:9px;color:#9CA3AF;text-align:center">
    Meticle Care Weekly Meal Plan &bull; Generated ${now} &bull; This plan should be reviewed by a qualified care professional before implementation.
  </div>
</body></html>`
}
...
export async function generateMealPlanPdf(weeklyPlan: any, shoppingList?: any): Promise<Buffer> {
  ...
  return generatePdf(html, {
    ...
    landscape: true,
    headerTemplate: '<div style="font-size:8px;color:#9CA3AF;width:100%;text-align:center;padding:3px 12mm">Meticle Care Weekly Meal Plan</div>',
