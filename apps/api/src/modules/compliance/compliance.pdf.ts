...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  <div class="cover">
    ...
    <h1>Evidence Pack</h1>
    <p class="subtitle">${orgName || 'Meticle Care'} — ${now}</p>
    <div class="meta">
  ...
  <p style="color:#6B7280;font-size:12px">Generated by Meticle Care on ${now}</p>
  ...
  <div style="margin-top:40px;padding-top:12px;border-top:1px solid #D1D5DB;font-size:10px;color:#9CA3AF;text-align:center">
    Meticle Care Evidence Pack &bull; Generated ${now} &bull; For inspection purposes
  </div>
</body></html>`
}
