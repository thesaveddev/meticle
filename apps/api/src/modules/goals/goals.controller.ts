...
export class GoalController {
  ...
  static async list(req: Request, res: Response) {
    ...
    const { person_id, status } = req.query as any;
    const goals = await GoalRepository.findAll(orgId, person_id, status);
    res.json(goals);
  }
  ...
  static async delete(req: Request, res: Response) {
    ...
    AuditRepository.log({ user_id: req.user!.userId, action: 'delete', entity_type: 'person_goal', entity_id: req.params.id, ip_address: req.ip }).catch(() => {});
  ...
  static async recordProgress(req: Request, res: Response) {
    ...
    AuditRepository.log({ user_id: req.user!.userId, action: 'update_progress', entity_type: 'person_goal', entity_id: req.params.id, new_data: { progress: req.body.progress, notes: req.body.notes }, ip_address: req.ip }).catch(() => {});
    res.json(updated);
  }
}
