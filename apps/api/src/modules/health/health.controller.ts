...
export class HealthController {
  ...
  static async getObservations(req: Request, res: Response) {
    ...
    const observations = await HealthRepository.findObservations(serviceUserId);
  ...
  static async deleteObservation(req: Request, res: Response) {
    const { serviceUserId, id } = req.params;
    await HealthRepository.deleteObservation(id, serviceUserId);
  ...
  static async updateObservation(req: Request, res: Response) {
    const { serviceUserId, id } = req.params;
    const updated = await HealthRepository.updateObservation(id, serviceUserId, req.body);
  ...
  static async getBowelMovements(req: Request, res: Response) {
    ...
    const movements = await HealthRepository.findBowelMovements(serviceUserId, dateFrom, dateTo);
    res.json(movements);
  }
  ...
  static async deleteBowelMovement(req: Request, res: Response) {
    const { serviceUserId, id } = req.params;
    await HealthRepository.deleteBowelMovement(id, serviceUserId);
  ...
  static async updateBowelMovement(req: Request, res: Response) {
    const { serviceUserId, id } = req.params;
    const updated = await HealthRepository.updateBowelMovement(id, serviceUserId, req.body);
  ...
  static async getDentalRecords(req: Request, res: Response) {
    const { serviceUserId } = req.params;
    const records = await HealthRepository.findDentalRecords(serviceUserId);
    res.json(records);
  }
  ...
  static async deleteDentalRecord(req: Request, res: Response) {
    const { serviceUserId, id } = req.params;
    await HealthRepository.deleteDentalRecord(id, serviceUserId);
  ...
  static async updateDentalRecord(req: Request, res: Response) {
    const { serviceUserId, id } = req.params;
    const updated = await HealthRepository.updateDentalRecord(id, serviceUserId, req.body);
  ...
  static async getFluidIntake(req: Request, res: Response) {
    ...
    const intake = await HealthRepository.findFluidIntake(serviceUserId, date);
    res.json(intake);
  }
  ...
  static async getDailyFluidTotal(req: Request, res: Response) {
    ...
    const total = await HealthRepository.getDailyFluidTotal(serviceUserId, date);
    res.json(total);
  }
  ...
  static async deleteFluidIntake(req: Request, res: Response) {
    const { serviceUserId, id } = req.params;
    await HealthRepository.deleteFluidIntake(id, serviceUserId);
  ...
  static async updateFluidIntake(req: Request, res: Response) {
    const { serviceUserId, id } = req.params;
    const updated = await HealthRepository.updateFluidIntake(id, serviceUserId, req.body);
