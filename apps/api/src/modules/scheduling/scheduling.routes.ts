...
router.post('/templates', requireRole(UserRole.ORG_ADMIN, UserRole.MANAGER), requirePermission('scheduling', 'edit'), validate(createTemplateSchema), asyncHandler(SchedulingController.createTemplate));
...
router.post('/', requireRole(UserRole.ORG_ADMIN, UserRole.MANAGER), requirePermission('scheduling', 'edit'), validate(createShiftSchema), asyncHandler(SchedulingController.createShift));
router.get('/:id', asyncHandler(SchedulingController.getShift));
router.patch('/:id', requireRole(UserRole.ORG_ADMIN, UserRole.MANAGER), requirePermission('scheduling', 'edit'), validate(updateShiftSchema), asyncHandler(SchedulingController.updateShift));
router.delete('/:id', requireRole(UserRole.ORG_ADMIN, UserRole.MANAGER), requirePermission('scheduling', 'edit'), asyncHandler(SchedulingController.deleteShift));
router.post('/:id/assign', requireRole(UserRole.ORG_ADMIN, UserRole.MANAGER), requirePermission('scheduling', 'edit'), validate(assignStaffSchema), asyncHandler(SchedulingController.assignStaff));
...
router.patch('/:shiftId/approve-claim/:staffId', requireRole(UserRole.ORG_ADMIN, UserRole.MANAGER), requirePermission('scheduling', 'edit'), asyncHandler(SchedulingController.approveOvertimeClaim));
router.patch('/:shiftId/reject-claim/:staffId', requireRole(UserRole.ORG_ADMIN, UserRole.MANAGER), requirePermission('scheduling', 'edit'), asyncHandler(SchedulingController.rejectOvertimeClaim));
