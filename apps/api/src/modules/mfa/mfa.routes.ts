...
import { authenticate, authenticateMfaSetup } from '../../shared/middleware/auth.middleware';
...
router.post('/setup', authenticateMfaSetup, validate(mfaSetupSchema), asyncHandler(MFAController.setup));
