...
const policyContent = (purpose: string, scope: string, responsibilities: string, process: string) =>
  `Purpose\n${purpose}\n\nScope\n${scope}\n\nResponsibilities\n${responsibilities}\n\nRequired practice\n${process}\n\nRecords and review\nRecord decisions, actions, and exceptions in the relevant Meticle Care module. The registered manager reviews this policy at least annually and after any serious incident, regulatory change, or identified learning.`;
